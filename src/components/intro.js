        ...
        <Router>
          <div>
            <Navbar dark expand="md" fixed="top" scrolling>
              <Container>
                <NavbarBrand>
                  <span className="white-text">Chan Geroy</span>
                </NavbarBrand>
                ...
                <Collapse isOpen={this.state.collapse} navbar>
                  <NavbarNav left>
                    ...
                    <NavItem>
                      <NavLink to="BlogPage">Features</NavLink>
                    </NavItem>
                    <NavItem>
            ...
            <Container className="px-md-3 px-sm-0">
              <Row>
                <Col md="12" className="mb-4 white-text text-center">
                  <h3 className="display-3 font-weight-bold mb-0 pt-md-5">Welcome to My Blog </h3>
                  <hr className="hr-light my-4 w-75" />
                  <h4 className="subtext-header mt-2 mb-4">This is a sample site for a blog made from MDBootstrap</h4>
                  <Button outline rounded color="white"><Fa icon="home" /> Read More</Button>
                </Col>
              </Row>
            </Container>
          </Mask>
